...
const LoginPage = () => {
    return (
        <div >
            <div className="grid md:grid-cols-12 mx-auto md:mt-10">

                {/* form */}
                <div className="col-span-5 md:px-10 pt-10 pb-8 shadow md:mx-14 px-2">
                    {/* title */}
                    <div>
                        <h2
                    ...
                    <div className="mt-5 md:mt-8">
                        ...
                        <form>
                            ...
                            <label htmlFor="Password" className="font-medium">
                                <span>Password </span>
                                <span className="text-purple-500 underline text-sm cursor-pointer md:ml-60 ml-40">Forget Password? </span>
                        ...
                        {/* social Login */}
                        <div>
                            <p className="ml-40 my-5 font-semibold">OR Login With</p>

                            <div className="flex items-center gap-10 md:justify-center">

                                {/* google */}
                                <div className="px-8 py-3 rounded border-2 border-red-500 flex items-center gap-3 cursor-pointer">
                                ...
                                {/* Github */}
                                <div className="px-8 py-3 rounded border-2 border-black flex items-center gap-3 cursor-pointer">
                ...
                {/* img */}
                <div className="hidden md:block col-span-7 bg-red-600">
                    img
                </div>
                {/* img */}
